...
export const error_project_empty: string = "An error occured... No projects will be treated, please make sure that projects passed are matching projects in the configuration file.";
